...
<html>
    <head>
        <title id="hdtitle">Phim đang chiếu</title>
        ...
        <div class="header">
            ...
            <div class="top">
                ...
                <div class="navigation">
                    ...
                    <div class="nav">
                        <ul>
                                <li class="mau"><a href="phim.php"><h1>Phim</h1></a></li>
            ...
            <div class="container-bg">
               ...
               <div class="cart-content">
                ...
                <div class="content-page">
                    <div class="sub-tab">
                        <ul>
                            <li class="" style="z-index: 3;"><a href="" data-name="playing">Phim đang chiếu</a></li>
                            <li style="z-index: 2;"><a href="" data-name="coming">Phim sắp chiếu</a></li>
                            <li style="z-index: 1;"><a href="" data-name="special">Suất chiếu đặc biệt</a></li>
                        </ul>
                    </div>
                    <!-- khung phim -->
                    <div class="movie-main">
                        <div id="playing" class="display-movie">
                        <?php
                            // Kết nối đến cơ sở dữ liệu
                            $conn = new mysqli("localhost", "nnv", "", "movie_theater");
                            ...
                            // Truy vấn dữ liệu phim có kiểu phim là "playing"
                            $query = "SELECT idPhim, tenPhim, moTa, linkImg FROM movie WHERE kieuPhim = 'playing'";
                            $result = $conn->query($query);

                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    echo '<div class="movie-of-day">';
                                    echo '<div style="display: flex;">';
                                    echo '<img src="' . $row['linkImg'] . '" alt="' . $row['tenPhim'] . '">';
                                    echo '<div class="">';
                                    echo '<h1>' . $row['tenPhim'] . '</h1>';
                                    echo '<p class="over-detail">' . $row['moTa'] . '</p>';
                                    echo '<p></p>';
                                    echo '<div class="but">';
                                    echo '<button><a href=""><h2>Trailer</h2></a></button>';
                                    echo '<a href="lichchieu.php"><button><h2>Mua vé</h2></button></a>';
                                    echo '</div>';
                                    echo '</div>';
                                    echo '</div>';
                                    echo '</div>';
                                ...
                                echo "Không có phim nào đang phát.";
                            }

                            // Đóng kết nối cơ sở dữ liệu
                            ?>
                        </div>
                        <div id="coming" class="display-movie">
                        <?php
                            $query = "SELECT idPhim, tenPhim, moTa, linkImg FROM movie WHERE kieuPhim = 'coming'";
                            $result = $conn->query($query);
                        ...
                        <div id="special" class="display-movie">
                        <?php
                            $query = "SELECT idPhim, tenPhim, moTa, linkImg FROM movie WHERE kieuPhim = 'special'";
                            $result = $conn->query($query);
                    ...
                    <script>
                        ...
                        // Xử lý sự kiện khi trang web được tải lên
                        window.addEventListener('load', function() {
                            // Ẩn tất cả nội dung trừ phần "Playing" ban đầu
                            coming.style.display = 'none';
                            special.style.display = 'none';
                    
                            // Mặc định hiển thị nội dung của "Playing" ban đầu
                        ...
                        playingTab.addEventListener('click', function(e) {
                            ...
                            // Ẩn tất cả nội dung trừ phần "Playing"
                            coming.style.display = 'none';
                            special.style.display = 'none';
                    
                            // Hiển thị nội dung của "Playing"
                            playing.style.display = 'block';
                        });
                    </script>
