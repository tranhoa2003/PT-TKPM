    ...
    <body>
                ...
                <div class="navigation">
                    ...
                    <div class="nav">
                        <ul>
                                ...
                                <li class="mau1"><a href="khuyenmai.php"><h1>Khuyến mãi</h1></a></li>
        ...
        <div class="container">
            <div class="container-bg">
                ...
                <div class="content-page" style="color: white;">
                    <center style="font-size: +50px; padding-top: 30px;">Promotions</center>
