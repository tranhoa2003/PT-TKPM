        ...
        <div class="container">
            <div class="container-bg">
                ...
                <div class="content-page">
                    <div class="about-section" style="min-height: 175px;">
                        <div class="about-top">
                            <div class="section-title"><h2>Giới thiệu</h2></div>
                            <div class="sub-tab about">
                                <ul>
                                    <li style="z-index: 3;"><a href="gioithieu.php" data-name="1" >Hệ thống Cinestar</a></li>
                                    <li class="current" style="z-index: 2;"><a href="gioithieudichvu.php" data-name="3" >Dịch vụ</a></li>
                                    <li style="z-index: 1;"><a href="gioithieucongnghephongchieu.php" data-name="2" >Công nghệ phòng chiếu</a></li>
                                </ul>
                            </div>
                            <div class="about-box" data-open="3" style="display: block; opacity: 1;">
                                <div class="service-wrap">
                                    <div class="khung">
                                        <div class="noidung">
                                            <h1>NHÀ HÁT - DALAT OPERA HOUSE</h1>
                                            <p style="padding: 10px">Nhà hát nằm trong công trình Bông Hoa Dã Quỳ, tọa lạc bên bờ Hồ Xuân Hương - <br> một trong những vị trí đẹp nhất của thành phố.</p>
                                            <p style="padding: 10px">
                                                NHÀ HÁT - DALAT OPERA HOUSE
                                                Nhà hát nằm trong công trình Bông Hoa Dã Quỳ, <br> tọa lạc bên bờ Hồ Xuân Hương - một trong những vị trí đẹp nhất của thành phố.
                                                
                                                Điểm <br> diễn này được cải tạo lại từ cung nghệ thuật, do UBND tỉnh Lâm Đồng đầu tư xây <br> dựng  trước đây, cùng các hạng mục khác trong công trình quảng trường Lâm Viên.
                                            </p>
                                            <p style="padding: 10px">Địa chỉ: Quảng Trường Lâm Viên, Tp. Đà Lạt</p>
                                            <p style="padding: 10px">Fanpage: https://www.facebook.com/DalatOperaHouse </p>
                                            <p style="padding: 10px">Hotline: 035 621 3536</p>
    
                                        </div>
                                        <div class="anh-khung">
                                            <img src="https://www.cinestar.com.vn/pictures/dich%20vu/350x250.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="khung1">
                                        <div class="noidung">
                                            <h1>HỆ THỐNG C'GAME - GAME XU GẮP <br>THÚ</h1>
                                            <p style="padding: 10px">Với nhiều trò chơi game xu đa dạng hấp dẫn, phù hợp với mọi lứa tuổi thuộc hệ thống <br> của  Cinestar</p>
                                            <p style="padding: 10px">
                                                Hiện nay chúng tôi đã phát triển tại các chi nhánh:
                                            </p>
                                            <p style="padding: 10px">- C'Game Huế</p>
                                            <p style="padding: 10px">- C'Game Đà Lạt  </p>
                                            <p style="padding: 10px">- C'Game Quốc Thanh</p>
    
                                        </div>
                                        <div class="anh-khung">
                                            <img src="https://www.cinestar.com.vn/pictures/dich%20vu/gamexu.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
