                ...
                <div class="content-page">
                    ...
                    <div class="chiTietPhim">
                        ...
                        <div class="MoTa">
                            ...
                            <div class="LienKet"><a href="#"><h2>TRAILER</h2></a> <a href="thanhtoan.php"><h2>Đặt vé</h2></a></div>
                        </div>
                    </div>
                    ...
                    // Lấy tenPhim từ tham số GET
                    $tenPhim = $_GET['tenPhim'];

                    // Truy vấn dữ liệu chi tiết phim
                    $sql = "SELECT moTa, linkImg, tenPhim, namSanXuat, theLoai, dienVien, daoDien FROM movie WHERE tenPhim = ?";
                    ...
                    if ($result !== false) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            $linkImg = $row["linkImg"];
                            $tenPhim = $row["tenPhim"];
                            $namChieu = $row["namSanXuat"];
                            $theLoai = $row["theLoai"];
                            $dienVien = $row["dienVien"];
                            $daoDien = $row["daoDien"];
                            
                            // Hiển thị thông tin trong các phần tử HTML
                            echo '<script>';
                            echo 'document.getElementById("chiTietImg").src = "' . $linkImg . '";';
                            echo 'document.getElementById("chiTietTenPhim").innerText = "' . $tenPhim . '";';
                            echo 'document.getElementById("chiTietNgayKhoiChieu").innerText = ' . $namChieu . ';';
                            echo 'document.getElementById("chiTietTheLoai").innerText = "' . $theLoai . '";';
                            echo 'document.getElementById("chiTietDienVien").innerText = "' . $dienVien . '";';
                            echo 'document.getElementById("chiTietDaoDien").innerText = "' . $daoDien . '";';
                            echo 'document.getElementById("chiTietMoTa").innerText = "' . $moTa . '";';
                            echo '</script>';
                        } else {
