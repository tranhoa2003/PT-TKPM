        ...
        <div class="container">
            <div class="container-bg">
                ...
                <div class="content-page" style="z-index: 0;">
                    <div class="about-section" style="min-height: 175px; height: auto; background: transparent;">
                        <div class="about-top">
                            <div class="section-title"><h2>Giới thiệu</h2></div>
                            <div class="sub-tab about">
                                <ul>
                                    <li class="current"><a href="gioithieu.php" data-name="1">Hệ thống Cinestar</a></li>
                                    <li><a href="gioithieudichvu.php" data-name="3">Dịch vụ</a></li>
                                    <li><a href="gioithieucongnghephongchieu.php" data-name="2">Công nghệ phòng chiếu</a></li>
                                </ul>
                            </div>
                            <div class="about-box" data-open="1" style="display: block; opacity: 1;">
                                <div class="intro-wrap">
                                    <div class="intro-item">
                                        <div class="intro-pic">
                                            <img src="https://www.cinestar.com.vn/pictures/webimages/6GioiThieu/z3981888411257_ec3f43e1704ef01c6e0006df549444ce.jpg" alt="CINESTAR LÂM ĐỒNG">
                                        </div>
                                        <div class="intro-txt">
                                            <h3>CINESTAR LÂM ĐỒNG</h3>
                                            <p></p>
                                            <p>Địa chỉ :&nbsp;Tầng 4, Trung tâm Thương mại và Dịch vụ Tài chính Sacombank, 713 Quốc lộ 20, thị trấn Liên Nghĩa, huyện Đức Trọng, tỉnh Lâm Đồng.</p>
                                            <p>Hotline:&nbsp;026 3730 0008 (Bấm phím 0)</p>
                                            <p>
                                                <img src="http://icons.iconarchive.com/icons/yootheme/social-bookmark/72/social-facebook-box-blue-icon.png" style="box-sizing: border-box; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; border: 0px; vertical-align: baseline; color: rgb(255, 255, 255); text-align: right; font-family: MyriadRegular; font-size: 16px; width: 18px; height: 18px;">&nbsp;
                                                <a href="" style="color: #f2b819; font-family: Arial, Helvetica, sans-serif;">https://www.facebook.com/CinestarDucTrong</a>
                                            </p>
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="intro-item">
                                        <div class="intro-pic">
                                            <img src="https://www.cinestar.com.vn/pictures/Tin%20tức/cinestar-insight/cinestar-kien-giang.jpg" alt="Cinestar Kiên Giang">
                                        </div>
                                        <div class="intro-txt">
                                            <h3>Cinestar Kiên Giang</h3>
                                            <p></p>
                                            <p><span style="font-size:14px;"><span style="font-family:arial,helvetica,sans-serif;">Địa chỉ:&nbsp;Lô A2 - Khu 2 Trung tâm Thương mại Rạch Sỏi, Đường Nguyễn Chí Thanh, Phường Rạch Sỏi, Thành phố Rạch Giá, Tỉnh Kiên Giang</span></span></p>
                                            <p><span style="font-size:14px;"><span style="font-family:arial,helvetica,sans-serif;">Hotline: +84&nbsp;(297)&nbsp;</span></span><span style="font-size: 15px;">730 6588</span></p>
                                            <p><span style="font-size:14px;"><span style="font-family:arial,helvetica,sans-serif;"><img src="http://icons.iconarchive.com/icons/yootheme/social-bookmark/72/social-facebook-box-blue-icon.png" style="font-size: 16px; width: 18px; height: 18px;">
                                            <a href="https://www.facebook.com/CinestarKienGiang" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #f2b819;">https://www.facebook.com/CinestarKienGiang/</a>
                                                </span></span>
                                            </p>
                                            <p></p>
                                        </div>
                        ...
                        <div class="bo-to">
                            <div class="intro-note" style="position: relative; top: 250px;">
                                <p><span style="font-size:18px;"><span style="font-family:arial,helvetica,sans-serif;">CINESTAR, KHÔNG GIAN GIẢI TRÍ TRẺ TRUNG VÀ SÔI ĐỘNG&nbsp;VỚI GIÁ CẢ HỢP LÝ</span></span></p>
                                <p class="welcom">Hãy đến CineStar Cinema để cảm nhận điện ảnh đích thực</p>
                            </div>
                            <div class="section-title" style="position: relative; top: 200px;">
                                <h2>Một số hình ảnh của rạp Cinestar</h2>
                            </div>
                            <div class="cinema-img-wrap">
                                <div class="cinema-img-slide slide-slidebox" style="opacity: 1; display: inline-block;">
                                    <div class="slide-wrapper-outer">
                                        <div class="slide-wrapper">
                                            <div class="slide-item">
                                                <div class="cinema-pic">   
                                                    <img alt="pic" src="https://www.cinestar.com.vn/pictures/webimages/6GioiThieu/website-csv-2.jpg" style="display: block;">
                                                </div>
                                                <div class="cinema-pic">
                                                    <img alt="pic" src="https://www.cinestar.com.vn/pictures/webimages/6GioiThieu/csv-2.jpg" style="display: block;">
                                                </div>
                                            </div>
                                            <div class="slide-item">
                                                <div class="cinema-pic">
                                                    <img alt="pic" src="https://www.cinestar.com.vn/pictures/webimages/6GioiThieu/csv-3.jpg" style="display: block;">
                                                </div>
                                                <div class="cinema-pic">
                                                    <img alt="pic" src="https://www.cinestar.com.vn/pictures/webimages/6GioiThieu/csv-4.jpg" style="display: block;">
                                                </div>
                                            </div>
                                            <div class="slide-item">
                                                <div class="cinema-pic">
                                                    <img alt="pic" src="https://www.cinestar.com.vn/pictures/webimages/6GioiThieu/avatar-web.jpg" style="display: block;">
                                                </div>
                                                <div class="cinema-pic">
                                                    <img alt="pic" src="https://www.cinestar.com.vn/pictures/webimages/6GioiThieu/hinh-anh-hue-2.jpg" style="display: block;">
                                                </div>
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="slide-controls clickable"></div>
                                </div>
                            </div>
                        </div>
                        
                        <div class="about-box" data-open="3" style="display: block; opacity: 1;"></div>
                        <div class="about-box" data-open="2" style="display: block; opacity: 1;"></div>
                    </div>
                    
                    
                    <!-- -----------------chuyen anh-------------- -->
                    <div class="morong" style="position: relative; top: 100px;"> 
